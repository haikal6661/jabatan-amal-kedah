...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <title>{{ __('Sistem Jabatan Amal Kedah') }}</title>
    <link rel="" sizes="76x76" href="{{ asset('material') }}/img/logo-amal.png">
    <link rel="icon" type="image/png" href="{{ asset('material') }}/img/logo-amal.png">
